...
class AlbumDeviceStorageScreen extends StatefulWidget {
  const AlbumDeviceStorageScreen({Key? key}) : super(key: key);

  @override
  _AlbumDeviceStorageScreenState createState() => _AlbumDeviceStorageScreenState();
}

class _AlbumDeviceStorageScreenState extends State<AlbumDeviceStorageScreen> {
